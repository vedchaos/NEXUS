...
TOOLS = [
    ...
    {"name": "ctz_db_multi_backup", "description": "Backup all configured databases (Postgres dumps, Mongo dumps, Redis BGSAVE)", "inputSchema": {"type": "object", "properties": {"output_dir": {"type": "string", "default": "./backups"}, "postgres": {"type": "object", "default": null}, "mongo": {"type": "object", "default": null}, "redis": {"type": "object", "default": null}}}},
]
